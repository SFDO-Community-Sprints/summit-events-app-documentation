...
![Add'l Config And Options Tab](https://sfdo-community-sprints.github.io/summit-events-app-documentation/docs/standard-features/images/Event-Addl-Config-And-Options.md)
